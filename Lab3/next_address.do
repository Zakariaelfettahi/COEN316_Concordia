...
# Additional test: bne rs,rt, loop with rs = rt (should NOT branch)
force pc x"00000005"
force rs x"00000003"
force rt x"00000003"
force target_address "00000000000000000000000011"
...
# Additional test: bltz with rs < 0 (should branch)
force pc x"00000006"
force rs x"FFFFFFFF"  ; -1 in 2's complement
force target_address "00000000000000000000000001"
force pc_sel "00"
force branch_type "11"
run 2

# Additional test: bltz with rs >= 0 (should NOT branch)
force pc x"00000007"
force rs x"00000002"
force target_address "00000000000000000000000001"
force pc_sel "00"
